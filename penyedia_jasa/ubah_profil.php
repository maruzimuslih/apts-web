                ...
                <form class="form-horizontal" method="post" action="proses_ubah_profil.php">
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="namaPJ" class="col-sm-4 col-form-label">Nama</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="namaPJ" id="namaPJ" value="<?php echo $profil['namaPJ'];?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="alamat" class="col-sm-4 col-form-label">Alamat</label>
                            <div class="col-sm-8">
                              <textarea name="alamat" class="form-control" id="alamat" cols="42" rows="3" required><?php echo $profil['alamat'];?></textarea>
                                
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="maps" class="col-sm-4 col-form-label">Tautan Google Maps</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="maps" id="maps" value="<?php echo $profil['googleMaps'];?>" required>
                            </div>
                        </div>                                             
                        <div class="form-group row">
                            <label for="kota" class="col-sm-4 col-form-label">Kota/Kabupaten</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kota" id="kota" value="<?php echo $profil['kota'];?>" required>
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="pool" class="col-sm-4 col-form-label">Pool</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="pool" id="pool" value="<?php echo $profil['pool'];?>" required>
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="telepon" class="col-sm-4 col-form-label">Telepon</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="telepon" id="telepon" value="<?php echo $profil['telepon'];?>" required>
                            </div>
                        </div>
                        <!--input-id_pj-->
