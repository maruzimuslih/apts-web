  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tambah Armada</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card-header">
                    <h3 class="card-title">Tambah Data Armada</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" name="tambaharmada" method="post" action="proses_tambah_armada.php">
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="namaArmada" class="col-sm-3 col-form-label">Nama Armada</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="namaArmada" id="namaArmada" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">                              
                                <select name="poolTujuan" id="poolTujuan" class="form-control" required>                                    
                                  <?php
                                    echo '<option value="" hidden >Pilih Kota Tujuan Terlebih dahulu</option>';
                                  ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group date" id="jamBerangkat" data-target-input="nearest">
                                    <input type="text" name="jamBerangkat" class="form-control datetimepicker-input" data-target="#jamBerangkat" required>
                            ...
                            <div class="col-sm-3">
                                <div class="input-group date" id="jamTiba" data-target-input="nearest">
                                    <input type="text" name="jamTiba" class="form-control datetimepicker-input" data-target="#jamTiba" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="kapasitasKursi" id="kapasitasKursi" required>
                            </div>
                            <div class="col-sm-1"></div>
