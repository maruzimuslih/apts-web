      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="kelola_pengguna.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Pengguna</p>
                </a>
              </li>
            ...
            <div class="card">              
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php                                       
                      $q_tabelPJ = mysqli_query($connect, "SELECT namaPJ, telepon, email, level, id_pj FROM tb_pj JOIN tb_user ON tb_pj.id_user=tb_user.id_user UNION ALL 
                      SELECT namaPenumpang, noHP, email, level, id_penumpang FROM tb_penumpang JOIN tb_user ON tb_penumpang.id_user=tb_user.id_user");                      
                      $no = 0;
                    ...
                    <tr>
                      <td><?php echo $no; ?></td>
                      <!-- 0 = nama -->
                      <td><?php echo $tabel[0]; ?></td>
                      <!-- 2 = email -->
                      <td><?php echo $tabel[2]; ?></td>
                      <!-- 1 = noTelp -->
                      ...
                      <td>                        
                        <button type="button" class="btn btn-block btn-danger btn-xs" title="Hapus" data-toggle="modal" data-target="#modal-sm<?php echo $no; ?>">
                          <i class="far fa-trash-alt"></i>
                        </button>

                            <div class="modal fade" id="modal-sm<?php echo $no; ?>">
                              <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body text-center">                      
                                      <p>Yakin ingin menghapus data pengguna ini?</p>                    
                                  </div>
                                  <div class="modal-footer justify-content-between">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                                    <button email="<?php echo $tabel[2]; ?>" type="button" data-dismiss="modal" class="btn btn-primary ajaxhapus">Ya</button>                                   
                                  </div>            
                                </div>
                                <!-- /.modal-content -->
                              </div>
