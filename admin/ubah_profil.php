                ...
                <form class="form-horizontal" method="post" action="proses_ubah_profil.php">
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="namaAdmin" class="col-sm-4 col-form-label">Nama</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="namaAdmin" id="namaAdmin" value="<?php echo $profil['namaAdmin'];?>" required>
                            </div>
                        </div>                        
                        <div class="form-group row">
                            <label for="email" class="col-sm-4 col-form-label">Email</label>
                            <div class="col-sm-8">
                                <input type="email" class="form-control" name="email" id="email" value="<?php echo $email['email'];?>" required>
                            </div>
                        </div>                                             
                        <div class="form-group row">
                            <label for="noTelp" class="col-sm-4 col-form-label">Nomor Telepon</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="noTelp" id="noTelp" value="<?php echo $profil['noTelp'];?>" required>
                            </div>
                        </div>                         
                        <!--input-id_admin-->
