  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tambah Data Bantuan (FAQ)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Beranda</a></li>
              <li class="breadcrumb-item"><a href="kelola_bantuan.php">Data Bantuan (FAQ)</a></li>
              <li class="breadcrumb-item active">Tambah Data Bantuan (FAQ)</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card-header">
                    <h3 class="card-title">Tambah Data Bantuan (FAQ)</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" name="tambahbantuan" method="post" action="proses_tambah_bantuan.php">
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="judul" class="col-sm-3 col-form-label">Judul</label>
                            <div class="col-sm-9">
                                <textarea name="judul" class="form-control" id="judul" cols="42" rows="2" required></textarea>                                
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="deskripsi" class="col-sm-3 col-form-label">Deskripsi</label>
                            <div class="col-sm-9">
                                <textarea name="deskripsi" class="form-control" id="deskripsi" cols="42" rows="5" required></textarea>                                
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="jenis" class="col-sm-3 col-form-label">Jenis Bantuan</label>
                            <div class="col-sm-9">
                                <input type="text" name="jenis" id="jenis" class="form-control" list="listJenis" required>
