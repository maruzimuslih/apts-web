        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="kelola_perPengguna.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Pertanyaan Pengguna</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Beranda</a></li>
              <li class="breadcrumb-item active">Pertanyaan Pengguna</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card">              
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php                    
                      $q_tabel = mysqli_query($connect, "SELECT * FROM tb_bantuantambahan ORDER BY id_bantuanTambahan DESC");                      
                      $no = 0;
                    ...
                    <tr>
                      <td><?php echo $no; ?></td>
                      <td><?php echo $tabel['subjek']; ?></td>
                      <td><?php echo $tabel['deskripsi']; ?></td>
                      <td><?php echo $tabel['email']; ?></td>                      
                      <td>                        
                        <button type="button" class="btn btn-block btn-danger btn-xs" title="Hapus" data-toggle="modal" data-target="#modal-sm<?php echo $tabel['id_bantuanTambahan']; ?>">
                            <i class="far fa-trash-alt"></i>
                            </button>

                            <div class="modal fade" id="modal-sm<?php echo $tabel['id_bantuanTambahan']; ?>">
                              <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body text-center">                      
                                      <p>Yakin ingin menghapus data pertanyaan ini?</p>                    
                                  </div>
                                  <div class="modal-footer justify-content-between">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                                    <button id_bantuanTambahan="<?php echo $tabel['id_bantuanTambahan']; ?>" type="button" data-dismiss="modal" class="btn btn-primary ajaxhapus">Ya</button>                                   
                                  </div>            
                                </div>
                                <!-- /.modal-content -->
                              </div>
...
<script>
  $('.ajaxhapus').click(function(){
    var id_bantuanTambahan = $(this).attr("id_bantuanTambahan");
    hapus_pertanyaan(id_bantuanTambahan);
  });
  function hapus_pertanyaan(id_bantuanTambahan) {
    $.ajax({
      type: "get",
      url: "proses_hapus_bantuanTambahan.php?",
      data: "id_bantuanTambahan="+id_bantuanTambahan,          
    }).done(function() {
      swal({ 
